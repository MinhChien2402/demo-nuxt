<template>
  <div class="popup-gallery-page" id="popup-gallery-page" :class="{ active: isGalleryPopupOpen }">
    <div class=" ct-popup-gallery">
      <div class="close-popup-icon" @click="closePopupGallery, $emit('close-modal')">
        <img src="~/assets/img-fix/close.png" alt="">
      </div>
      <div class="container">
        <div class="row">
          <div class="col-12">
            <div class="wp-title-gallery-popup">
              <h3 class="name-tour-gallery">
                {{ SanPhamDetail.description }}
              </h3>
              <div class="wp-day-ctg text-center">
                <span class="day-create">2019/06/20</span>
              </div>
            </div>
            <div class="slider-gallery">
              <div id="slider-popup-featureJob" v-swiper:[SanPhamDetail.id]="galleryFeature"
                class="swiper-container slider-popup-gallery-top">
                <div class="swiper-wrapper">
                  <div class="swiper-slide" style="display: flex; justify-content: center !important">
                    <img-comparison-slider class="item-image-before-after">
                      <img slot="first" :src="SanPhamDetail.imageA" alt="Original" />
                      <img slot="second" :src="SanPhamDetail.imageB" alt="Processed" />
              ...
              <div id="btn-album-prev" class="arrow-control-album arrow-left">
              ...
              <div id="btn-album-next" class="arrow-control-album arrow-right">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="30" viewBox="0 0 15 30" fill="none">
                  <path
...
export default {
  ...
  async asyncData({ store }) {
    await store.dispatch('SanPhamDetail')
  },
  ...
  computed: { ...mapGetters(['SanPhamDetail']) },
  methods: {
    openPopupGallery() {
